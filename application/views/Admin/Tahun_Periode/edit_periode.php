        ...
        <div class="card-body">
            <form class="mx-5 mt-3" method="post" action="<?= base_url('admin/tahunperiode/edit/') . $periode['id_periode']; ?>">
                ...
                <div class="input-group mb-3 w-50">
                    ...
                    <input type="text" id="InputAnggaran" name="anggaran" class="form-control" placeholder="Masukan jumlah anggaran..." aria-describedby="basic-addon1" value="<?= $periode['anggaran']; ?>">
                </div>

                <label for="InputNamaPeriode">Kuota</label>
                <div class="input-group mb-3 w-50">
                    <input type="text" name="kuota" class="form-control" placeholder="Masukan jumlah kuota..." aria-describedby="basic-addon2" value="<?= $periode['kuota']; ?>">
