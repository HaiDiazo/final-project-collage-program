        ...
        <div class="card-body">
            <form class="mx-5 mt-3" method="post" action="<?= base_url('admin/tahunperiode/input'); ?>">
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control" id="InputNama" placeholder="Masukan Nama Periode" autocomplete="off" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="keterangan" class="form-control" id="InputAlamat" rows="3" placeholder="Masukan Keterangan" autocomplete="off" required></textarea>
                </div>
