                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="ml-3 align-middle">
                                    ...
                                    if ($cek != count($kriteria)) { ?>
                                        <a href="<?= base_url('admin/spk/proses/proses_kriteria'); ?>" class="mt-2 btn btn-primary" style="font-size:11px;"><i class="bi bi-arrow-right-square"></i></a>
                                    <?php } else { ?>
                            ...
                            if (count($subkriteria->result_array()) == 0) {
                                ...
                                foreach ($subkriteria->result_array() as $subkr) :
                                    if ($temp == 0) {
                                        ...
                                        if ($subkr['bobot'] != null) {
                                            echo "<td rowspan='" . count($subkriteria->result_array) . "' class='align-middle'><a href='" . base_url('admin/spk/proses/proses_subkriteria/') . $subkr['id_kriteria'] . "' class='btn btn-primary' style='font-size:11px;'><i class='bi bi-arrow-right-square'></i></a></td>";
                                        } else {
