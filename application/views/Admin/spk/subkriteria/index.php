                    ...
                    <?php foreach ($kriteria as $kr) :  ?>
                        ...
                        <tr>
                            ...
                            if (count($subkriteria->result_array()) == 0) {
                                ...
                                echo '<td class="text-center align-middle" rowspan="' . count($subkriteria->result_array()) . '"><a href="' . base_url('admin/spk/subkriteria/tambahsub/') . $kr['id_kriteria'] . '" class="btn btn-primary" style="font-size:11px;"><i class="bi bi-plus"></i></a></td>';
                            } else {
                                $temp = 0;
                            ...
                            ?>
                                        ...
                                        <td class="text-center align-middle" rowspan="<?= count($subkriteria->result_array()); ?>">
                                            <a href="<?= base_url('admin/spk/subkriteria/perband_sub/') . $kr['id_kriteria']; ?>" class="btn <?php echo ($exist_or_no[$j] > 0) ? "btn-success" : "btn-secondary"; ?>" style="font-size:11px;">
