            ...
            <?php if ($sub == "angka") { ?>
                <form action="<?= base_url('admin/spk/subkriteria/insert_subKrit_angka/') . $id_kriteria; ?>" method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control w-25" style="font-size: 12px;" name="nilai1" id="inputSub1" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control w-25" style="font-size: 12px;" name="nilai2" id="inputSub2" value="">
                        </div>
                    </div>
