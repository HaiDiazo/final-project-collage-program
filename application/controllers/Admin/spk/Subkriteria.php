...
class Subkriteria extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("admin/spk/subkriteria/index", $data);
    ...
    public function tambahsub($kriteria)
    {
        ...
        $submenu = "<a href=" . base_url('admin/spk/subkriteria') . ">Konfigurasi Sub Kriteria</a> /";
        $data = [
            'spk' => 'subkriteria',
            'title' => $title,
            'nama_user' => $nama_user,
        ...
        if ($cek['nama_kriteria'] == "penghasilan" || $cek['nama_kriteria'] == "usia" || $cek['nama_kriteria'] == "tanggungan") {
            $data['sub'] = "angka";
        } else {
            $data['sub'] = "not_angka";
        }
        ...
        $this->load->view("admin/layout_admin/layout_header", $data);
        $this->load->view("admin/spk/subkriteria/tambah_subkriteria", $data);
        $this->load->view("admin/layout_admin/layout_footer");
    }
    ...
    public function edit_sub($id_subkriteria)
    {
        ...
        $this->load->view("admin/layout_admin/layout_header", $data);
        $this->load->view("admin/spk/subkriteria/edit_subkriteria", $data);
        $this->load->view("admin/layout_admin/layout_footer");
    }
    ...
    public function insert_subKrit($kriteria)
    {
        ...
        if ($insert == 1) {
            ...
            redirect('admin/spk/subkriteria/tambahsub' . $kriteria);
        }
    }
    ...
    public function perband_sub($id_krit)
    {
        ...
        $this->load->view("admin/layout_admin/layout_header", $data);
        $this->load->view("admin/spk/subkriteria/perband_subkriteria", $data);
        $this->load->view("admin/layout_admin/layout_footer");
    }
    ...
    public function subkriteria_masuk($jum, $id_kriteria)
    {
        ...
        if ($cek_jumlah == 0) {
            ...
            if ($insert == 1) {
                echo "Sukses Insert";
                redirect('admin/spk/proses/proses_subkriteria/' . $id_kriteria);
            } else {
                echo "Gagal Insert";
                redirect('admin/spk/subkriteria/perband_sub/' . $id_kriteria);
            }
        } else {
            for ($i = 0; $i < $jum; $i++) {
                $data = [
